...
// Hull bottom sits exactly at wave surface (baseY ≈ 0), tilts with wave slope.
const BOAT_CFG = {
  speed: 0.011, baseY: 0.1,          // hull bottom just at wave surface — no flying, no sinking
  bobFreq: [0.35, 0.62], bobAmp: [0.05, 0.03],   // very gentle bob
